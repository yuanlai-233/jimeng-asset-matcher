...
在支持 Git 和 Python 3.9+ 的 Agent 终端中粘贴下面这一行，即可安装 Skill 和浏览器扩展文件：
...
工具条、提示卡、弹窗和背景音乐按钮会自动跟随即梦网页的浅色 / 深色模式切换，无需刷新页面；保留原有尺寸、间距和果冻点击动效。新版仍包含 v0.3.18 的背景音乐开关与 v0.3.17 起的图片、视频、音频自动上传。

![浅色模式](docs/images/08-theme-light.png)

![深色模式](docs/images/09-theme-dark.png)

![深色模式 150% 缩放](docs/images/10-theme-dark-150.png)
...
![安装示意（旧版截图）：当前更新后请确认版本为 0.3.22](docs/images/01-install.png)
