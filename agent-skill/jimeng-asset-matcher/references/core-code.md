...
本包保留 v0.3.20 发布包中全部 26 个运行文件，位于 `assets/extension/`，包含 19 个 JavaScript 文件、CSS、manifest、4 个图标与 MIT 许可证。除发布仓库中的 README、CHANGELOG、截图和 `.gitignore` 外，扩展运行文件与 v0.3.20 发布目录逐文件一致，未重写核心逻辑。
