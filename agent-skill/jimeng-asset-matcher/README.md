...
| [assets/extension](assets/extension) | v0.3.24 完整运行源码、图标及 manifest |
...
上游项目：[GitHub](https://github.com/yuanlai-233/jimeng-asset-matcher) · [v0.3.24 发布](https://github.com/yuanlai-233/jimeng-asset-matcher/releases/tag/v0.3.24)。
